...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (typeof checkLoginAndEnforce === 'function') {
        checkLoginAndEnforce();
    }
        ...
        modal.innerHTML = `
            <div class="modal-content" style="max-width: 600px;">
                ...
                <div class="modal-body">
                    <p style="margin-bottom: 20px;">选择您想要运行 BRAIN Alpha 回测器的方式：</p>
...
async function openSubmitter() {
    try {
        ...
        const baseUrl = localStorage.getItem('inspire_llm_url')
            || localStorage.getItem('transformer_llm_base_url')
            || 'https://api.moonshot.cn/v1';
        const model = localStorage.getItem('featureEngModelName')
            || localStorage.getItem('transformer_llm_model')
            || 'kimi-k2.5';
